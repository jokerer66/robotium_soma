...
public class sendphoto extends ActivityInstrumentationTestCase2 {
	private Solo solo;
	...
	public void test_sendAllPhoto() {
//		String filename[] = { "测试专用图－－相机拍摄", "测试专用图－－iPhone拍摄完",
//				"测试专用图－－iPhone拍摄（", "微博长图", "android 图片测试","风景" };
		String filename[] = { "测试专用图－－相机拍摄", "测试专用图包2",
				"测试专用图包3", "微博长图", "测试专用图包4","风景" };
//		String filename[] = { "风景" };
//		String filename[] = { "测试专用图－－相机拍摄"};
